...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('residencia_transacionales', function (Blueprint $table) {
            $table->increments('idResidenciaTransacional');
    ...
    {
        Schema::dropIfExists('residencia_transacionales');
    }
};
